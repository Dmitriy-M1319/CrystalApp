...
def custom_docs():
    ...
    openapi_schema = get_openapi(
        ...
        description="Данная документация предоставляет API для информационной системы, представляющей собой интернет-магазин дляреализации фильтров для воды, а также менеджмент-систему склада и заказов пользователей для администраторов",
        routes=app.routes,
    )
